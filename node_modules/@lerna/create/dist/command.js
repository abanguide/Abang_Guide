...
var import_minimatch3, import_npmlog37, import_slash2, childProcess11;
...
var require_src = __commonJS({
  "libs/commands/create/src/index.ts"(exports2, module2) {
    ...
    var CreateCommand = class extends Command2 {
      ...
      gitConfig(prop) {
        return childProcess13.execSync("git", ["config", "--get", prop], this.execOpts);
      }
      ...
      setRepository() {
        try {
          const url2 = childProcess13.execSync("git", ["remote", "get-url", "origin"], this.execOpts);
