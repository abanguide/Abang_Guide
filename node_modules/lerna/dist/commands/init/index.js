  ...
  "libs/commands/init/src/index.ts"(exports2, module2) {
    ...
    var InitCommand = class {
      ...
      async generate(tree) {
        ...
        return async () => {
          if (isGitInitialized(this.cwd)) {
            ...
            await childProcess10.exec("git", ["init"], {
              cwd: this.cwd,
              maxBuffer: 1024
            });
          }
          if (this.args.skipInstall === void 0) {
            ...
            await childProcess10.exec(command, args, {
              cwd: this.cwd,
      ...
      detectPackageManager() {
        const packageManager = (0, import_fs4.existsSync)("yarn.lock") ? "yarn" : (0, import_fs4.existsSync)("pnpm-lock.yaml") ? "pnpm" : (0, import_fs4.existsSync)("package-lock.json") ? "npm" : null;
        if (packageManager) {
